...
function Canvas(props) {
    ...
    useEffect(() => {
        ...
        setSnap(c, props.gridScale)
        setCanvas(c, props.gridScale);
        drawGrid(c, props.gridScale);
        setDelete();
    ...
    function drawToken(tokenImage, x, y){
        ...
        fabric.Image.fromURL(tokenImage.src, function(img) {
          ...
          oImg.scaleToWidth(props.gridScale);
          oImg.scaleToHeight(props.gridScale);
          canvas.add(oImg)
        });
    ...
    function drawGrid(canvas, scale){
      ...
      function drawBackground(image, scale = props.mapScale){
        let width = document.body.clientWidth;
        let height = document.body.clientHeight;
